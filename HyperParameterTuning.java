...
public class HyperParameterTuning {
    public static final int labelIndex = 11;
    ...
    public static class ExampleDataSource implements DataSource {
        ...
        public RecordReader dataPreprocess() throws IOException, InterruptedException {
            ...
            Schema schema = new Schema.Builder()
                    ...
                    .addColumnString("LastName")
                    .addColumnInteger("BusinessScore")
                    .addColumnCategorical("Geography",Arrays.asList("U.S.","Canada","Mexico"))
                    .addColumnCategorical("Gender", Arrays.asList("Male","Female"))
                    .addColumnsInteger("Age", "Tenure", "Balance", "NumOfProducts", "HasCrCard", "IsActiveMember", "NumOfSpreadsheetsGenerated", "Exited").build();

            //Schema Transformation
            TransformProcess transformProcess = new TransformProcess.Builder(schema)
                    .removeColumns("RowNumber", "LastName", "CustomerId")
                    .categoricalToInteger("Gender")
                    .categoricalToOneHot("Geography")
                    .removeColumns("Geography[U.S.]")
                    .build();
